...
def parse_args():
    ...
    parser.add_argument("--pointcloud-preprocess", default="none", choices=["none", "open3d"])
    parser.add_argument("--pcd-voxel-size", type=float, default=0.0)
    parser.add_argument("--pcd-outlier-filter", default="none", choices=["none", "statistical", "radius"])
    parser.add_argument("--pcd-stat-nb-neighbors", type=int, default=20)
    parser.add_argument("--pcd-stat-std-ratio", type=float, default=2.0)
    parser.add_argument("--pcd-radius", type=float, default=0.05)
    parser.add_argument("--pcd-min-neighbors", type=int, default=4)
    parser.add_argument("--pcd-estimate-normals", action="store_true")
